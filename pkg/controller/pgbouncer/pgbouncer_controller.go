...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner PgBouncer
...
func (r *ReconcilePgBouncer) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &pgbounceroperatorv1alpha1.PgBouncer{}
	...
	// Set PgBouncer instance as the owner and controller
...
func newPodForCR(cr *pgbounceroperatorv1alpha1.PgBouncer) *corev1.Pod {
